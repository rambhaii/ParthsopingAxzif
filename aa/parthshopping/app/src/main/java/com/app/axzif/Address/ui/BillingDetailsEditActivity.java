...
public class BillingDetailsEditActivity extends AppCompatActivity implements View.OnClickListener , AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        operatorDeta=getIntent().getStringExtra("operator");
        ...
        ArrayAdapter aa = new ArrayAdapter(BillingDetailsEditActivity.this,android.R.layout.simple_spinner_item,spinner_arrary);
  ...
  if (status.equalsIgnoreCase("1"))
    ...
    private void setValue()
    {
        ...
        Gson gson = new Gson();
        operatorAddrr = gson.fromJson(operatorDeta, Category.class);
        name.setText(" "+operatorAddrr.getName());
        Address1.setText(" "+operatorAddrr.getAddress());
        country.setText(" "+operatorAddrr.getCountry());
        PostcodeZIP.setText(" "+operatorAddrr.getZip());
        CityTown.setText(" "+operatorAddrr.getCity());
        State.setText(" "+operatorAddrr.getState());
        EnterLandmark.setText(" "+operatorAddrr.getLandmark());
        Log.d("jhgfjhf",operatorAddrr.getMobile());
        Phone.setText(operatorAddrr.getMobile());
        AlternateMobileNo.setText(" "+operatorAddrr.getAltMobile());
        AdditionalInformation.setText(" "+operatorAddrr.getAdditionalInfo());
        tv_SUBMIT.setText("UPDATE");
        addressId=operatorAddrr.getId();
        Log.d("djghjdfhg",addressId);
    }
        ...
        if(view==tv_SUBMIT){
            ...
            if (validateForm() == 0)
            {
                ...
                loader.setCanceledOnTouchOutside(false);
                    ...
                    UtilMethods.INSTANCE.UpdateAddress(this,addressId,CityTown.getText().toString().trim()   ,
                            State.getText().toString().trim(),
                          country.getText().toString().trim(),    PostcodeZIP.getText().toString().trim(),
                            EnterLandmark.getText().toString().trim(),
                          Address1.getText().toString().trim(),    Phone.getText().toString().trim(),
                            AlternateMobileNo.getText().toString().trim(),
                          name.getText().toString().trim(),    AdditionalInformation.getText().toString().trim(),
                          address_type, loader,0,BillingDetailsEditActivity.this);
            } else {
